...
import { useCollaborationPost, usePostApplications } from "../../hooks/useCollaboration"; // Hook check
...
const PostDetail = () => {
    ...
    return (
        <div style={pageStyle}>
            {/* Header */}
            <DashboardHeader customStyle={{ marginBottom: 0, paddingLeft: 20, paddingRight: 20 }} />
                ...
                {post.requiredSkills && post.requiredSkills.length > 0 && (
                    <div style={section}>
                        ...
                        <div style={skillsContainer}>
                            {post.requiredSkills?.map((skill: string, idx: number) => (
