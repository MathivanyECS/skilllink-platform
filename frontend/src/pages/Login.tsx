  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 bg-black text-white">
      ...
      <div className="flex items-center justify-center px-6">
        <div className="w-full max-w-md bg-white/10 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-green-500/20 relative">

          {/* 🔙 Back Button */}
          <button
            type="button"
            onClick={() => navigate("/")}
            className="absolute top-4 left-4 text-green-400 hover:text-green-300 transition"
          >
            <FaArrowLeft size={16} />
          </button>
          ...
          <div className="flex justify-center gap-4">
            <button className="w-12 h-12 flex items-center justify-center rounded-lg border border-gray-600 hover:border-green-400 transition">
              <img src="/src/assets/images/google-icon.png" alt="Google" className="w-5 h-5" />
            </button>

            <button className="w-12 h-12 flex items-center justify-center rounded-lg border border-gray-600 hover:border-green-400 transition">
              <img src="/src/assets/images/facebook-icon.jpg" alt="Facebook" className="w-6 h-6" />
            </button>
          </div>
